...
<body>
    <div class="flex flex-col justify-start items-center h-full bg-white w-1607">
        <h2 class="m-4 text-2xl font-bold">Create a Blog Post</h2>

        <div id="create-post" class="w-1/2 p-8 border bg-snow border-light-grey shadow-onyx">
            <form method="POST" action="/create-post" class="flex flex-col">
                ...
                <div class="form-group mb-4 flex flex-col">
                    ...
                    <textarea name="body_1" class="form-control  border border-light-grey  hover:border-x-sea-green" rows="5" required>{{ old('body_1', session('post_data.body_1')) }}</textarea>
                </div>

                <div class="form-group mb-4 flex flex-col">
                    <label for="body_2" class='mb-4'>Body 2:</label>
                    <textarea name="body_2" class="form-control  border border-light-grey  hover:border-x-sea-green" rows="5" required>{{ old('body_2', session('post_data.body_2')) }}</textarea>
                </div>

                <button type="submit" class="btn btn-primary bg-iris mx-auto w-1/4 text-white rounded  hover:bg-sea-green">Submit</button>
            </form>
        </div>
    </div>
</body>
