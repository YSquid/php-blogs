...
<body>
    <div id='header' class="flex  bg-slate-50 justify-between items-center p-4">
        <div id='socials' class='flex ml-4 bg-red-50 justify-between h-auto w-auto space-x-4'>
            ...
            <a href="https://ahmadkariem.com/" target="_blank" title="Website"><i
                    class="fa-solid fa-globe fa-2xl"></i></a>
        </div>
        <div id='link'>
            @auth
        ...
        <div id='title' class='mr-4'>
            @auth
            <a href="/admin"><h1>Status201</h1></a>
            @else
            <a href="/"><h1>Status201</h1></a>
            @endauth
        </div>
    </div>
</body>
